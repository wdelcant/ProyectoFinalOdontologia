...
document.addEventListener('DOMContentLoaded', function() {
    ...
    RegionesYcomunas.regiones.forEach(function() {
    ...
    document.getElementById('regiones').innerHTML = htmlRegion;
    document.getElementById('comunas').innerHTML = htmlComunas;

    document.getElementById('regiones').addEventListener('change', function() {
        var iRegiones = 0;
        var valorRegion = this.value;
        var htmlComuna = '<option value="sin-comuna">Seleccione comuna</option><option value="sin-comuna">--</option>';
        RegionesYcomunas.regiones.forEach(function() {
            if (RegionesYcomunas.regiones[iRegiones].NombreRegion == valorRegion) {
                var iComunas = 0;
                RegionesYcomunas.regiones[iRegiones].comunas.forEach(function() {
        ...
        document.getElementById('comunas').innerHTML = htmlComuna;
    });

    document.getElementById('comunas').addEventListener('change', function() {
        if (this.value == 'sin-region') {
            alert('selecciones Región');
        } else if (this.value == 'sin-comuna') {
